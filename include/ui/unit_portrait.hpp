...
//
// The other thing this client renders into a widget rather than reading off
// disk is an authored scene - the M2 behind the login and character screens -
// and that is rendering::GlueScene, which the preview underneath a portrait
// also draws its figure into.
